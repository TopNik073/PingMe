...
class Pings(BaseModel):
    ...
    sender: Mapped['Users'] = relationship('Users', foreign_keys=[sender_id], back_populates='sent_pings')
    recipient: Mapped['Users'] = relationship('Users', foreign_keys=[recipient_id], back_populates='received_pings')
