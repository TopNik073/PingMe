...
class RateLimiter:
    ...
    def __init__(
        ...
        self.requests: dict[UUID, dict[str, list[float]]] = defaultdict(lambda: defaultdict(list))
    ...
    def _check_rate_limit(self, user_id: UUID | None, message_type: str, limit: int) -> bool:
