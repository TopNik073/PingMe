...
async def join_to_conversation(
    ...
    try:
        ...
        conversation = await conversation_service.get_conversation_by_id(join_data.conversation_id)
...
async def get_participants(
    ...
    try:
        ...
        participants_data = [ParticipantResponse.model_validate(participant) for participant in participants]
        return response_success(
...
async def search_conversations(
    ...
    try:
        ...
        conversations_brief = [ConversationBriefResponse.model_validate(conv) for conv in conversations]
